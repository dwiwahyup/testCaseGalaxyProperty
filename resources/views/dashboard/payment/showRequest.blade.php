...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Salary Payment Request Detail</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Salary Payment Request Detail</li>
                </ol>
            </nav>
        </div>
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Salary Payment Request Detail</h5>
                                <table class="table">
                                    <tr>
                                ...
                                @if($payment->status == 'pending')
                                    <div class="d-flex gap-2">
                                        <form method="POST" action="{{ route('payment.salary.approval.approve', $payment->id) }}">
                                            @csrf
